...
\addcontentsline{toc}{chapter}{Abstract}
    ...
    Looking at the sensitivity in the unlimited case, we find that the values of $\he$ are not sensitive to the changes in the prior, whereas the values of $\ha$ tend to be a smaller with one of the priors. However, in the limited version, the model is sensitive to the changes in the prior and tend to estimate smaller values for all three parameters for the smallest values of the hyperparameters we use here. 
