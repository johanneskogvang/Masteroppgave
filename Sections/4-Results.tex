...
\begin{figure}
    \centering
    \scalebox{0.5}{\input{tikz-trees/binom_unlim_a0_g1_k1}}
    \caption[IO solution, unlimited. $\alpha=0$, $\gamma=\kappa=1$]{Unlimited, $\alpha = 0$, $\gamma=\kappa=1$.}
