...
\begin{figure}
    ...
    \caption{All cis of $\alpha$ except individual 11}
...
\begin{figure}
    ...
    \caption{Al cis beta except person 11 and 75}
...
\subsubsection{Unlimited}
plotting al cis except for perosn 58 with very high values
\begin{figure}
    \centering
    \includegraphics[scale=0.38]{pictures/Gamma=kappa=0.5/all_cis_alpha_unlim.png}
    \caption{Caption}
