...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[scale=0.39]{pictures/ci_unlim_person61.png}
        \caption{ci unlim person 61}
        \label{fig:ci_unlim_person_61}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[scale=0.39]{pictures/ci_unlim_person61_zoomed.png}
        \caption{ci unlim peron 61 zoomed}
