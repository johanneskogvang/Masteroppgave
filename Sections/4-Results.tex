...
In Figures \ref{fig:all_cis_alpha_lim} and \ref{fig:all_cis_beta} we see that individual 11 has long confidence intervals fro $\alpha$ and $\beta$. In Figure \ref{fig:ci_lim_a_b_person_11} we have plotted $\ha$ and $\hb$ of the 1000 bootstrap samples for individual 11 together with the confidence intervals for $\alpha$ and $\beta$.
...
As so many of the values of $\ha$ are zero, the plots including this will give little information. We therefore skip the plot with $\ha$ and $\hb$, and continue with the plot for $\hb$ and $\he$. These are shown in Figure \ref{fig:sensitivity_mles_lim_b_e}. Here we find an individual with a high value of $\hb$ that gets an even higher value with the new prior. In addition to this, she gets a higher value of $\he$. 
\begin{figure}
    \centering
