...
\end{equation*}
%\begin{equation*}
%    [\hat{\alpha}^{*(5)}_{1000},\hat{\alpha}^{*(95)}_{1000}] = [0,0.0796],
%\end{equation*}
%\begin{equation*}
%    [\hb^{*(5)}_{1000},\hb^{*(95)}_{1000}] = [0,0.5857]
%\end{equation*}
%and
%\begin{equation*}
%    [\hat{\eta}^{*(5)}_{1000},\hat{\eta}^{*(95)}_{1000}] = [21.29,2716.5].
%\end{equation*}
\begin{figure}
    \centering
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{pictures/Sensitivity/mles_unlim.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.6]{pictures/Sensitivity/mles_lim_a_e.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.62]{pictures/Sensitivity/mles_lim_b_e.pdf}
...
All the participants that had $\hb=0$ with the uniform prior still have that with the non-uniform prior. %More participants have $\hb=0$ now than with the uniform prior. 
...
\begin{figure}
    ...
    \includegraphics[scale=0.38]{pictures/Sensitivity/ci_lim_alpha_zoom1_pdf.pdf}
...
\begin{figure}
    ...
    \includegraphics[scale=0.37]{pictures/Sensitivity/ci_lim_beta_zoom1_pdf.pdf}
...
\begin{figure}
    ...
    %\includegraphics[scale=0.37]{pictures/Sensitivity/ci_lim_eta_zoomed_pdf.pdf}
