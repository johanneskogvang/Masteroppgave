...
all alpha vlaues that are zero (that is all except two) stay at zero. 
all eta vlaues except person 11 and 13 (the ones with high alpha values) are shifted upwards. Some shifted only 0.3-0.5, others (few) are shifted somewhere between 15 and 40 upwards. 

as so many of the $\ha$ are zero, we skip teh $\ha$-$\hb$ plot nd oonly look at $\hb$ together with $\he$. 