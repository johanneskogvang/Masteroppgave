...
\begin{figure}
    \centering
    \scalebox{0.5}{\input{tikz-trees/unif_unlim_a1e-15}}
...
\begin{figure}
    ...
    \caption{IO sol person 32 and 33 (simliar)}
    \label{fig:IO_sol_lim_person32and33}
\end{figure}
\begin{figure}
    \centering
    \scalebox{0.7}{\input{tikz-trees/unif_lim_a0_b0.2377}}
    \caption{IO sol person 32 and 33 (simliar)}
    \label{fig:IO_sol_lim_person32and33_unif}
\end{figure}
...
In Figure \ref{fig:mles_limited_alpha_beta} we have plotted the MLEs of $\alpha$ and $\beta$ for all participants. We see a person with a high value if $\hat{\beta}$. This is the same person that has the high $\hat{\eta}$ value in Figure \ref{fig:mles_limited_alpha_eta}, person 75. This person is also seen in the top right corner of Figure \ref{fig:mles_limited_beta_eta} that displays $\hat{\beta}$ and $\hat{\eta}$ for all participants.
\begin{figure}
    \centering
...
This is all about person 75, write sentecne about that:
